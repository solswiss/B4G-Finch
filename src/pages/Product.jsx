...
const Product = () => {
    return (
        <>
            <div id="product" className="pt-[4.75rem] lg:pt-[5.25rem] overflow-hidden px-7 text-center dark:bg-n-8">
                <Section className="">
                    <h1 className="h1 font-display mb-4 text-color-1 dark:text-color-6">The streamlined internship process for students</h1>
                    <h4 className="text-md text-color-6 dark:text-white/80">Finch makes applications effortless</h4>
                    <Button className="my-12 bg-color-3 text-white" href={extensionLink} >Download the Chrome Extension</Button>
                </Section>
                <Section className="bg-n-3 dark:bg-n-8">
                    <h3 className="h3 font-display text-color-1 dark:text-color-2">How It Works</h3>
                    <ol className="list-decimal list-inside text-left px-7 dark:text-white/80">
                ...
                {/**FIX some colors work and others dont??? */}   
                <Section className="dark:bg-n-8">
                ...
                <Section className="dark:bg-n-8">
                <p className="mb-7 dark:text-white/80 text-2xl">Say goodbye to mass applying and hello to a smarter, more efficient internship search.</p>

                <div className="flex gap-4 justify-center mb-7">
                    <Link to="/Pricing"><Button className="dark:bg-n-6">
                        Get started
                    </Button>
                    </Link>
                    <Link to="/Contact"><Button className="bg-color-5">
                        Have questions?
                    </Button>
                    </Link>
                </div>
